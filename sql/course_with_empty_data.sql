...
UPDATE "settings" SET "value" = 'ArticleLessons, VideoLessons, CourseCheckout, SocialShare, SocialLogins, RatingAndReview, UserProfile, Comments, SEO, PayPal' WHERE name = 'site.enabled_plugins';

UPDATE "settings" SET "value" = 'Graspr' WHERE "name" = 'site.name';
