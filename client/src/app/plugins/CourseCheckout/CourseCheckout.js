...
(function(module) {
    ...
    module.controller('buyButtonController', ['$scope', '$modal', '$rootScope', '$filter', function($scope, $modal, $rootScope, $filter) {
        var model = this;
...
(function(module) {
    ...
    module.controller('paymentController', ['$scope', 'getGatewaysByUser', '$sce', 'Countries', 'payNow', 'ViewCourse', '$state', '$window', '$location', 'flash', '$filter', '$rootScope', 'TokenServiceData', 'pageType', '$modalStack', function($scope, getGatewaysByUser, $sce, Countries, payNow, ViewCourse, $state, $window, $location, flash, $filter, $rootScope, TokenServiceData, pageType, $modalStack) {
        var model = this;
        if (pageType === "page") {
...
(function(module) {
    ...
    module.controller('transactionsController', ['TransactionList', '$scope', '$rootScope', 'User', '$filter', 'TokenServiceData', '$state', function(TransactionList, $scope, $rootScope, User, $filter, TokenServiceData, $state) {
        var model = this;
...
(function(module) {
    ...
    module.factory('getGatewaysByUser', ['$resource', 'GENERAL_CONFIG', function($resource, GENERAL_CONFIG) {
        return $resource(
    ...
    module.factory('TransactionList', ['$resource', 'GENERAL_CONFIG', function($resource, GENERAL_CONFIG) {
        return $resource(
