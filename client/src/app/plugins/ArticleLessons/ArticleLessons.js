...
(function(module) {
    ...
    module.controller('articleLessonsFormController', ['Course', '$scope', 'addOnlineCourseLessons', 'OnlineCourseLessons', 'OnlineCourseLessonsUpdate', '$filter', 'flash', '$rootScope', function(Course, $scope, addOnlineCourseLessons, OnlineCourseLessons, OnlineCourseLessonsUpdate, $filter, flash, $rootScope) {
        var model = this;
